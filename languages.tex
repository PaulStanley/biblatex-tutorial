...
\biblatex\ is pretty well set up for the task. This section aims to
...
\item If you are writing in a language which requires accents and
 ...
 \end{pseudoverb}
\item Load \package{babel}\footnote{Or, if you use it,
...
\package{Biblatex} (or, more accurately, \package{biber}) is perfectly
