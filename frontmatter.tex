...
The \biblatex\ package is a tour de force: a monumental piece of programming by its originator (Philip Lehmann) and its current maintainer(s) (Phil Kime---who is also responsible for \package{biber}, assisted by others). It is powerful. But with power comes complexity. The manual is a mine of information, but sometimes rather overwhelming.
