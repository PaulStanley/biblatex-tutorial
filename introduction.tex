...
then you should read the first section.\intref{p~\pageref{newbie}} If you
already have experience of using automated bibliography tools in
\LaTeX, such as \bibtex\ and \package{Natbib}, then you can probably
jump straight to the second section.\intref{p~\pageref{expert}}
...
of available `helper' programs.\intref{chapter:tools}
