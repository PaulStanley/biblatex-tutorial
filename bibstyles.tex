...
\begin{figure}
\fbox{\includegraphics[width=\textwidth]{./examples/cotton-numeric.pdf}}
...
\fbox{\includegraphics[width=\textwidth]{./examples/cotton-alphabetic.pdf}}
\end{figure}
...
\fbox{\includegraphics[width=\textwidth]{./examples/cotton-authoryear.pdf}}
\end{figure}
...
\fbox{\includegraphics[width=\textwidth]{./examples/cotton-authortitle.pdf}}
\end{figure}
