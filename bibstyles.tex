\chapter{Citation Styles: The Menu}
...
Biblatex styles also fall into these three families, and there are
...
\biblatex\, which will load both citation style and bibliography style.
...
provide accurate implementations of particular detailed guides.
...
2013 \\
Anghewandte Chemie & \texttt{biblatex-chem}           & 1.1l & 2013
\\
...
If there isn't an exact style, you will have to find one that comes
...
For \smallcaps{superscript citations}, you have three options:
\begin{enumerate}
...
Changing the \smallcaps{punctuation between multiple citations} is
easy. By default it's a comma. You change it by redefining
\cs{multicitedelim}. So if you want a semicolon, you would put (in
your preamble)
\begin{center}
\verb|\renewcommand{\multicitedelim}{\addsemicolon\space}|
\end{center}

Occasionally one sees styles where the \smallcaps{label is in
