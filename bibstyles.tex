...
work. This topic is covered in some detail below.\intref{Page
  \pageref{recipe:brackets}.}
...
First, the number of names that get printed.\intref{See further, page
  \pageref{recipes:maxnames}.}  By default, up to three names will be
