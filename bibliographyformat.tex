...
\verb|title| option in the \cs{printbibliography} command.
...
\begin{itemize}
\item If \marginnote{\gives\ {\large\textbf{References}}\\(not in
...
\item If\marginnote{\gives\ {\large\textbf{References}}\\(in table of
    contents)} you want the heading added to the table of contents,
  but you don't want it numbered, then add the option
  \verb|heading=bibintoc| to your \cs{printbibliography} command.
...
\end{center}
The \angled{title} is the default title for your heading. The
