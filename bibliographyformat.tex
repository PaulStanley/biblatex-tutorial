...
the \cs{printbibliography} command.
...
\end{center}
The \angled{name} is a name you will use to refer to the environment
you have defined; it can be anything you choose. The \angled{title} is
