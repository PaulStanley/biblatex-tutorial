...
\paragraph{\textbackslash cite.} The \cs{cite} command is “basic”. It
...
\cs{footcite\{jones\}} is equivalent to \cs{footnote\{\textbackslash
...
\cs{footcite} because it always assumes that the citation will begin a
...
instance, the \package{biblatex-chem} wil
...
we did \cs{cite[prenote][postnote]\{key1,key2\}} we will get [prenote
