...
\item If you want a standard set of options to apply to all your
  ...
  must do when you load \biblatex.\index{customization!biblatex.cfg@\texttt{biblatex.cfg}}\index{files!biblatex.cfg@\texttt{biblatex.cfg}}\csindex{ExexcuteBibliographyOptions}
